...
def upgrade() -> None:
    ...
    op.create_index("ix_ai_providers_name", "ai_providers", ["name"], unique=False)
    op.create_index("ix_ai_providers_provider_type", "ai_providers", ["provider_type"], unique=False)
    op.create_index("ix_ai_providers_is_active", "ai_providers", ["is_active"], unique=False)
...
def downgrade() -> None:
    op.drop_index("uq_ai_models_default_provider", table_name="ai_models")
