...
class AIProviderRouter:
    ...
    def _env_providers(self) -> list[AIProvider]:
        ...
        if cf_token and cf_base and cf_model and not self._is_stale_model_id(cf_model):
            providers.append(AIProvider(name="cloudflare", api_key=cf_token, base_url=self._normalize_base_url(cf_base), models=(cf_model,), priority=25, provider_type="openai_compatible"))
