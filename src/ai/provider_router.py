...
class AIProviderRouter:
    ...
    Supports explicit AI_PROVIDERS_JSON plus direct Render ENV pairs AI_* and AI2_*.
    """
    ...
    def _parse(self) -> list[AIProvider]:
        ...
        # Explicit JSON pool wins. If it is empty, use the primary/secondary ENV pair.
        if not providers:
